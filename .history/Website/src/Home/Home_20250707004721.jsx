...
let Radiator = function() {
    ...
    return (
        <header>
            <h1 className={styles.title}>Welcome to Plumbzone Bathrooms</h1>
    ...
    <div className={styles.card}>
        <img className='card-image' src={showerEnclosure} alt="Shower Enclosure" />
    ...
    <div className={styles.card}>
        <img className='card-image' src={toilet} alt="Toilets" />
    ...
    <div className={styles.card}>
        <img className='card-image' src={baths} alt="BathTubs" />
    ...
    <div className={styles.card}>
        <img className='card-image' src={taps} alt="Bathroom Taps" />
    ...
    <div className={styles.card}>
        <img className='card-image' src={boiler} alt="Boilers" />
    ...
    <div className={styles.card}>
        <img className='card-image' src={radiator} alt="Bathroom Radiators" />
